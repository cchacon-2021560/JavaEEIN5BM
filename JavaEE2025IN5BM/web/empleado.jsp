            ...
            <div class="panel-formulario">
                ...
                <div class="formulario">
                    <form action="Controlador?menu=Empleado" method= "POST" class="formulario">
                        <input type="text" autocomplete="off" name="txtCodigoEmpleado" class="input" value="${empleado.getCodigoEmpleado()}" placeholder="ID">
                        <input type="text" autocomplete="off" name="txtNombreEmpleado" class="input" value="${empleado.getNombreEmpleado()}" placeholder="Nombre Empleado">
                        <input type="text" autocomplete="off" name="txtApellidoEmpleado" class="input" value="${empleado.getApellidoEmpleado()}" placeholder="Apellido">
                        <input type="text" autocomplete="off" name="txtDireccionEmpleado" class="input" value="${empleado.getDireccionEmpleado()}" placeholder="Dirección">
                        <input type="text" autocomplete="off" name="txtTelefonoEmpleado" class="input" value="${empleado.getTelefonoEmpleado()}" placeholder="Teléfono">
                        <input type="text" autocomplete="off" name="txtEmailEmpleado" class="input" value="${empleado.getEmailEmpleado()}" placeholder="Correo Electrónico">
                        <input type="text" autocomplete="off" name="txtPuestoEmpleado" class="input" value="${empleado.getPuestoEmpleado()}" placeholder="Puesto">
                    </form>
                </div>

                <div class="botones">
                    <button class="btn-insertar" name="Accion" value="Agregar">
